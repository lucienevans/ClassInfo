...
public class WidgetProvider_4_2 extends AppWidgetProvider {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equals(context.getString(R.string.classinfo_widget_datachange_action))) {
			...
			ComponentName name = new ComponentName(context, WidgetProvider_4_2.class);
	...
	private RemoteViews getWidgetViews(int mornClassNum, int afterClassNum, int evenClassNum, Context context, Calendar time, List<Class> classes) {
		int classNum = 0;
		RemoteViews widgetViews = new RemoteViews(context.getPackageName(), R.layout.widget_provider4_2);
		int[] timeInfoIds = { R.id.time_info1, R.id.time_info2, R.id.time_info3, R.id.time_info4 ,R.id.time_info5,R.id.time_info6};
		int[] classInfoIds = { R.id.class_info1, R.id.class_info2, R.id.class_info3, R.id.class_info4,R.id.class_info5,R.id.class_info6 };
		int[] classLayoutIds = { R.id.classinfo_layout1, R.id.classinfo_layout2, R.id.classinfo_layout3, R.id.classinfo_layout4,R.id.classinfo_layout5,R.id.classinfo_layout6 };
